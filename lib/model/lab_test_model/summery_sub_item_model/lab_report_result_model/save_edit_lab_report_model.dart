class SaveEditLabReportModel {
  ...
  SaveEditLabReportModel.fromJson(Map<String, dynamic> json) {
    if (json['templateList'] != null) {
      templateList = <TemplateList>[];
      json['templateList'].forEach((v) {
        templateList!.add(new TemplateList.fromJson(v));
      });
    }
    serviceItem = json['ServiceItem'] != null
        ? new ServiceItem.fromJson(json['ServiceItem'])
        : null;
    invoiceStatusUpdate = json['InvoiceStatusUpdate'];
    invoiceID = json['InvoiceID'];
    isNewResult = json['IsNewResult'];
    reagentExpenseCategoryId = json['reagentExpenseCategoryId'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.serviceItem != null) {
      data['ServiceItem'] = this.serviceItem!.toJson();
    }
    data['InvoiceStatusUpdate'] = this.invoiceStatusUpdate;
    data['InvoiceID'] = this.invoiceID;
    data['IsNewResult'] = this.isNewResult;
    data['reagentExpenseCategoryId'] = this.reagentExpenseCategoryId;
    return data;
  }
}
...
class TemplateList {
  ...
  TemplateList.fromJson(Map<String, dynamic> json) {
    ...
    patientService = json['PatientService'] != null
        ? new PatientService.fromJson(json['PatientService'])
        : null;
    unit = json['Unit'] != null ? new Unit.fromJson(json['Unit']) : null;
    opinion = json['Opinion'];
    itemWiseValue = json['ItemWiseValue'];
    machineName = json['MachineName'];
    labReportResultComment = json['LabReportResultComment'];
    ...
    activePosition = json['activePosition'];
    isNameDisable = json['IsNameDisable'];
    isUnitDisable = json['IsUnitDisable'];
    isOpinionDisable = json['IsOpinionDisable'];
    isRefDisable = json['IsRefDisable'];
    isTechDisable = json['IsTechDisable'];
    autoFocus = json['AutoFocus'];
    boldImage = json['BoldImage'];
    isReferanceColumn = json['IsReferanceColumn'];
    isTechonologyColumn = json['IsTechonologyColumn'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.patientService != null) {
      data['PatientService'] = this.patientService!.toJson();
    }
    if (this.unit != null) {
    ...
    data['LabReportResultComment'] = this.labReportResultComment;
    ...
    data['activePosition'] = this.activePosition;
    data['IsNameDisable'] = this.isNameDisable;
    data['IsUnitDisable'] = this.isUnitDisable;
    data['IsOpinionDisable'] = this.isOpinionDisable;
    data['IsRefDisable'] = this.isRefDisable;
    data['IsTechDisable'] = this.isTechDisable;
    data['AutoFocus'] = this.autoFocus;
    data['BoldImage'] = this.boldImage;
    data['IsReferanceColumn'] = this.isReferanceColumn;
    data['IsTechonologyColumn'] = this.isTechonologyColumn;
    return data;
  }
}
...
class PatientService {
  ...
  PatientService.fromJson(Map<String, dynamic> json) {
