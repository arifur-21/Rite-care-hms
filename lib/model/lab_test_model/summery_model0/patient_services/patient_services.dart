...
import 'doctor.dart';
import 'item.dart';
import 'modified_by_user.dart';
import 'patient.dart';
import 'service_provider.dart';

part 'patient_services.g.dart';

@JsonSerializable()
class PatientServices extends Equatable {
  ...
  final ModifiedByUser? modifiedByUser;
  ...
  factory PatientServices.fromJson(Map<String, dynamic> json) {
    return _$PatientServicesFromJson(json);
  }

  Map<String, dynamic> toJson() => _$PatientServicesToJson(this);

  PatientServices copyWith({
    dynamic patientId,
    dynamic itemId,
    dynamic invoiceId,
    dynamic receiptId,
