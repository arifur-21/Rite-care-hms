...
class SearchRepository{
  ...
  Future<LabReportResultModel> getTableRowDesignItem()async{
    dynamic response = await _apiServices.getApiData('/Item/GetTableRowDesignByItemId?itemId=301225&machineId=&groupItemId=&serviceId=933702');
