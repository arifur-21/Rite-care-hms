...
class Repository{
  ...
  /// get ot schdule streem
  Stream<OtScheduleModel> getOtScheduleStreem(dynamic startDate, dynamic endDate)async*{
    dynamic response = await _apiServices.getStreenData("${AppUrl.base_url}/OT/GetOperationScheduleList?pageNumber=1&pageSize=150&startDate=${startDate}&endDate=${endDate}&patientId=0&isMobileApp=true");
    yield OtScheduleModel.fromJson(response);
  }
