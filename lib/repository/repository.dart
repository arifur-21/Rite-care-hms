...
class Repository{
  ...
  Future<LabTestListModel> getLabTestListApi(dynamic labStatus, dynamic page)async{
    ...
    dynamic response = await _apiServices.getApiData('/Item/GetLabItemsByMedicalType?medicalTypeID=62&pageNumber=$page&pageSize=25&categoryId=${labStatus}&searchTerm=&allData=undefined&ItemId=0&isLabItemSerialNo=false');
