...
import '../view_model/lab_test_view_model/lab_test_list_view_model.dart';
                ...
                children: [
                  ...
                  _drawerSublistWidget(
                      ...
                      onTap: (){
                        ...
                        summeryVM.getSummeryListData(serviceId: 0, statusId: 0);
                        Navigator.pop(context);
                  ...
                  _drawerSublistWidget(
                      ...
                      onTap: (){
                        summeryVM.getSampleListData(serviceId: 0);
                        Navigator.pop(context);
                  ...
                  _drawerSublistWidget(
                      ...
                      onTap: (){
                        setState(() {
                          ...
                          labTestListVm.getLabTestListData(page: 1,labStatus: 0 );
                        });
