...
class Items {
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    startTime = json['StartTime'] != null
        ...
        : null;
    endTime =
    json['EndTime'] != null ? new EndTime.fromJson(json['EndTime']) : null;
...
//  ParentPatient? parentPatient;
  ...
  Patient.fromJson(Map<String, dynamic> json) {
    ...
    sex = json['Sex'];
    oldDob = json['OldDob'];
    // relationship = json['Relationship'] != null ? new Relationship.fromJson(json['Relationship'])
    //  : null;
    rank = json['Rank'];
    unit = json['Unit'];
    trade = json['Trade'];
    //parentPatient = json['ParentPatient'] != null? new ParentPatient.fromJson(json['ParentPatient'])
    //  : null;
  }
