                    ...
                    if(tableRowDesignVm.tableRowDesignListItem.value.design?.length == 0){
                      ...
                      return ListView.builder(
                        itemCount: tableRowDesignVm.tableRowDesignListItem.value.design?.length,
                          ...
                          print("report length ${tableRowDesignVm.tableRowDesignListItem.value.design?.length}");
                        return  Padding(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      Container(child: Text("${tableRowDesignVm.tableRowDesignListItem.value.design![index].unit?.name}")),
                                    ],
                                  )
                                ],
                              ),
