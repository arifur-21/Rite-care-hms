                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 20,),
                          Text("Patient List", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Center(
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 20,),
                            Text("Summery List", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ),
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 20,),
                                Text("Sample List", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                SizedBox(height: 20,),
                                Text("Lab Test List", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                Text("OT List", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
                        ...
                        child: Center(
                          child: Column(
                            children: [
                              ...
                              Image.asset('assets/icons/patients.png',height: 50, width: 80,),
                              SizedBox(height: 20,),
                              Text("Patient List", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                            ],
                          ),
                        ),
                      ),
