...
import '../../view_model/summery_view_model/body_data_print_model.dart';
...
class _ReportScreenState extends State<ReportScreen> {
  ...
  final bodyDataVM = Get.put(BodyDataPrintModel());
  ...
  void initState() {
    print("==============patient id============");
    print(widget.patientService.patient?.id);
    print("test 1");
    print(widget.patientService.id);
    print(widget.patientService.itemId);
    ...
    designList = tableRowDesignVm.tableRowDesignListItem.value.design ?? [];

    //  listController = [TextEditingController()];
    print("test 2");
    listController = List.generate(
        tableRowDesignVm.tableRowDesignListItem.value.design?.length ?? 0,
        (index) => TextEditingController());

    print("test 3");
    print(
        "length11 ${tableRowDesignVm.tableRowDesignListItem.value.design?.length}");
    print("list controller11 ${listController.length}");
                ...
                showDialog(
                    ...
                    builder: (context) {
                      return Dialog(
                        ...
                        child: SelectableText(bodyDataVM.bodyData.value),
                      ));
                    });
              },
              icon: Icon(Icons.abc))
        ...
        children: [
                ...
                return Expanded(
                  child: Obx(() {
                    switch (tableRowDesignVm.rxRequestStatus.value) {
                      ...
                      case Status.ERROR:
                        print(
                            "error ${tableRowDesignVm.error.value.toString()}");
                        return Text(tableRowDesignVm.error.value.toString());

                      case Status.SUCCESS:
                        if (tableRowDesignVm.tableRowDesignListItem.value.design
                                    ?.length ==
                                null ||
                            tableRowDesignVm.tableRowDesignListItem.value.design
                                    ?.length ==
                                0) {
                          ...
                          return ListView.builder(
                              itemCount: tableRowDesignVm
                                  .tableRowDesignListItem.value.design!.length,
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Expanded(
                                                  flex: 3,
                                                  child: Text(
                                                      "${tableRowDesignVm.tableRowDesignListItem.value.design![index].name}")),
                                              const SizedBox(
                                                width: 5,
                                              ),
                                              Expanded(
                                              ...
                                              Expanded(
                                                  flex: 1,
                                                  child: Text(
                                                      "${tableRowDesignVm.tableRowDesignListItem.value.design![index].unit?.name}")),
                                            ],
                                          )
                                        ],
                                      ),
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                        "${tableRowDesignVm.tableRowDesignListItem.value.design![index].referanceValue}"),
                                                    const SizedBox(
                                                      width: 10,
                                                    ),
                                                    //  Text("Female : 15-19"),
          ...
          InkWell(
              onTap: () async {
                ...
                print("=========service Date============");
                print(FunctionClass.dateOfTiemConterter(
                ...
                ReportBodyDataModel bodyModel = ReportBodyDataModel(
                    ...
                    serviceItem: ServiceItem(
                      ...
                      serviceDate: FunctionClass.dateOfTiemConterter(
                              widget.patientService.serviceDate)
                          .toString(),
