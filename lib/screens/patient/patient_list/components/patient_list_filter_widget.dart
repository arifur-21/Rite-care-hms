                        ...
                        children: [
                          ...
                          Visibility(
                              ...
                              child: InkWell(
                                  onTap: (){
                                    setState(() {
                                      patientList.startDate =  DateFormat("yyyy-MM-dd").format(DateTime.now());
                                      patientList.endDate =  DateFormat("yyyy-MM-dd").format(DateTime.now());
                                      patientList.getPatientList(page: 1, statusId: 0);
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    ExpansionTile(
                      leading: Text( "${bloodGroupHT.toString()}" , style: Styles.poppinsFontBlack12_400),
                      title: Text(""),
                      children: [
                        SizedBox(height: 10,),
                        ...
                        builder: (contxt, data){
                          return   Autocomplete<RankModel>(
                            ...
                            onSelected: (selectedValue){
                              ...
                              print("select value ${unitId}");
                            },
                          );
                        }),
/*
                    ResueableFilterTextFieldWidget(controllerValue: patientList.patientUnitController.value,
                      hintText: "Unit Id",),*/
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                          onTap: () {
                            patientList.getPatientList(statusId: bloodStatusId);
