        ...
        child: Column(
          children: [
            ...
            Expanded(
              ...
              child: FutureBuilder(
                future: labTestListVm.getLabTestListData(),
                ...
                return   Obx((){
                  switch(labTestListVm.rxRequestStatus.value){
                    ...
                    case Status.SUCCESS:
                      if(labTestListVm.labtestListData.value.items?.length == null){
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              if(index < labTestListVm.labtestListData.value.items!.length){
                                return   Padding(
