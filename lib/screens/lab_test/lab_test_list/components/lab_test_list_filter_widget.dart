                                                              ...
                                                              child: InkWell(
                                                                  onTap: () {
                                                                   // summeryVm.statusId = summeryVm.sampleListFilterStatus[index].id;
                                                                    print("lab test status = ${labTestListVM.labTestListFilterStatus[index].name}");
                                                                    labTestStatus = labTestListVM.labTestListFilterStatus[index].name!;
                                                                  },
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                          onTap: (){
                            labTestListVM.getLabTestListStatusData(labStatus: labTestStatus);
                          },
                          child: Center(
                              child: Text(
