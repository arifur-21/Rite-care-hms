...
class _PatientSummeryScreenState extends State<PatientSummeryScreen> {
                            ...
                            Obx((){
                              switch(summeryVM.rxRequestStatus.value){
                                ...
                                case Status.SUCCESS:
                                  ...
                                  userTenentId = summeryVM.loggedInUser?.value?.tenantId;
                                  userSPermissionId = summeryVM.loggedInUser?.value?.serviceProviderSignPermission?.id;
                                  return Text( summeryVM.loggedInUser?.value?.phoneNumber);


                              }
                            }),

                                  Text("user id ${userTenentId}"),
                                  Text("user pern ${userSPermissionId}"),
  ...
  void _scrollListener(){
    ...
    if(scrollController.position.pixels ==
      ...
      page = page + 1;
      summeryVM.getSummeryListData(page: page);
