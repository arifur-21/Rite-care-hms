...
class ExpandableSummeryListItem extends StatefulWidget {
  ...
  ExpandableSummeryListItem({ this.name, this.onPressed, this.statusId, this.status, this.summeryList, this.index});
                  ...
                  child: Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("${widget.summeryList![index].item}", style: Styles.poppinsFontBlack12_500),
