...
class _ExpandableSummeryListItemState extends State<ExpandableSummeryListItem> {
  ...
  Widget build(BuildContext context) {
    print("user tenent id ${widget.userTenentId}");
    return Column(
      children: [
        Container(
          height: 150,
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              pS_labStatusId =
                  serviceId = widget.summeryList![index].labStatusId;
              pS_signApprovedBy =
                  serviceId = widget.summeryList![index].signApprovedBy;
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                                flex: 1,
                                child: Text(
                                    "${widget.summeryList![index].item?.name}",
                            ...
                            Expanded(
                                flex: 1,
                                child: Text(
                                    "${widget.summeryList![index].doctorName}",
                            ...
                            Expanded(
                                flex: 1,
                                child: Text(
                                    "${widget.summeryList![index].item?.itemCategory?.name}",
                                    style: Styles.poppinsFontBlack12_300))
                          ],
                        ),
                        const SizedBox(
                                ...
                                InkWell(
                                  ...
                                  child: Visibility(
                                    ...
                                    false
                                        : widget.btnVisibility =
                                    false,
                                    child: const Text("Mark as Printed"),
                                  ),
                                ),
                                const SizedBox(
                                  width: 10,
                            ...
                            /*       Obx((){
                                switch(summeryVm.rxRequestStatus.value){
                                  ...
                                  case Status.SUCCESS:
                                    ...
                                    lU_TenentId = summeryVm.loggedInUser?.value?.phoneNumber;
            ...
            builder: (context, setState) => AlertDialog(
              ...
              content: Container(
                ...
                child: Column(
                  ...
                  children: [
                    const Text("Do you want to change status"),
                    const SizedBox(
                      height: 10,
                    ),
                    Text(
