...
class _SummeryListFilterWidgetState extends State<SummeryListFilterWidget> {
  ...
  @override
  void initState() {
    summeryVm.getSummeryListFilterStatus();
    super.initState();
  }
                        ...
                        Visibility(
                            ...
                            child: InkWell(
                                onTap: (){
                                  ...
                                  //  summeryVm.getSummeryListData(statusId: 0);
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child:  ListView.builder(
                                          shrinkWrap: true,
                                          itemCount: summeryVm.summeryListFilterStatus.value.length,
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                      onTap: () {
                                                        ...
                                                        setState((){
                                                          statusId = summeryVm.summeryListFilterStatus[index].id;
                                                          isClick = !isClick;
                                                        });
                                                      },
                                                      child:  Text("${summeryVm.summeryListFilterStatus[index].name}", style: TextStyle(color: statusId == summeryVm.summeryListFilterStatus[index].id ? Colors.red : Colors.black ))),
                                                ),
                                              ),
                                            );
                                          }),
              ...
              actions: [
                ...
                Column(
                  children: [
                    ...
                    FutureBuilder(
                        future: summeryVm.getSummeryLabTestNameSuggData(),
                        builder: (contxt, data) {
                          return Autocomplete<LabTestNameSuggModel>(
                            optionsBuilder: (TextEditingValue textValue) {
                              summeryVm.getSummeryLabTestNameSuggData(query: textValue.text);
                              print("query text ${textValue.text}");
                              if (textValue.text.isEmpty) {
                                return List.empty();
                              }
                              return summeryVm.labTestNameSuggList
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                         ...
                         //   summeryVm.categoryId.value = statusId;
