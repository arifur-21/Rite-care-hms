...
class _SampleListState extends State<SampleList> {
          ...
          Expanded(
            child: Obx(() {
              switch (simpleVM.rxRequestStatus.value) {
                ...
                case Status.SUCCESS:
                  if (simpleVM.sampleListItem.value.items?.length == 0 ||
                      simpleVM.sampleListItem.value.items?.length == null) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          statusId = simpleVM.sampleListItem.value.items?[index].labStatusId;
                          print("sample status id ${statusId}");


                          dobs = simpleVM.sampleListItem.value.items?[index].invoiceDate;
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "${simpleVM.sampleListItem.value.items?[index].invoiceNo}",
  ...
  void _scrollListener(){
    ...
    if(scrollController.position.pixels ==
      ...
      page = page + 1;
      simpleVM.getSampleListData(page: page);
